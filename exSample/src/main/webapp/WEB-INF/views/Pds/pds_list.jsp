      ...
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2">
				  <a class="list" href="/Pds/pds_view?idx=${pds.idx}&page=${page}">${pds.subject}</a></font></td>
						...
						<tr>
							<td>
								<select name="search">
									...
									<option value="name" ${pageSearchDTO.search=="subject" ? "selected" :""}>작성자</option>
									<option value="ccontents" ${pageSearchDTO.search=="subject" ? "selected" :""}>글내용</option>
								</select>
							</td>
